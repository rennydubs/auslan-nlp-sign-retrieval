...
def process_text():
    ...
    try:
        ...
        semantic_threshold = options.get(
...
def get_suggestions():
    ...
    try:
        ...
        suggestions = system.phrase_matcher.get_phrase_suggestions(
            partial_text, limit=8
        )

        return jsonify({"partial_text": partial_text, "suggestions": suggestions})
